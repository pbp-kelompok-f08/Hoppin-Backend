"""
Django settings for sosmed_PBPF08 project.
...
SECRET_KEY = 'django-insecure--yd9^8)&_p)@_0p11q%pk-qy2uupqiqvmc4gw(*)*@hp61f^nr'
...
WSGI_APPLICATION = 'sosmed_PBPF08.wsgi.application'
